          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="md:py-8">
              ...
              <div className="flex items-center mb-6 md:mb-10">
                ...
                <a
                  href="#"
                  className="text-amber-500 hover:text-amber-600 active:text-amber-700 text-sm font-semibold transition duration-100 ml-4"
                >
                  view all 47 reviews
                </a>
              </div>
              ...
              <div className="flex gap-2.5">
                <a
                  href="#"
                  className="inline-block flex-1 sm:flex-none bg-amber-500 hover:bg-amber-600 active:bg-amber-700 focus-visible:ring ring-amber-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3"
                >
                  Add to cart
                </a>
                ...
                <a
                  href="#"
                  className="inline-block bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-amber-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 py-3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6"
