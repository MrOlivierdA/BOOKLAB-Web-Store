                ...
                <div className="flex flex-col items-start gap-2">
                  <div className="w-20 h-12 flex border rounded overflow-hidden">
                    <input
                      type="number"
                      value="1"
                      className="w-full focus:ring ring-inset ring-amber-300 outline-none transition duration-100 px-4 py-2"
                    />
                  ...
                  <button className="text-amber-500 hover:text-amber-600 active:text-amber-700 text-sm font-semibold select-none transition duration-100">
                    Delete
                  </button>
                </div>
