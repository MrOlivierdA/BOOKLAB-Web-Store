        ...
        <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          <form className="max-w-lg border rounded-lg mx-auto">
            <div className="flex flex-col gap-4 p-4 md:p-8">
              ...
              <button className="flex justify-center items-center bg-amber-500 hover:bg-amber-600 active:bg-amber-700 focus-visible:ring ring-amber-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 gap-2 px-8 py-3">
                <svg
            ...
            <div className="flex justify-center items-center bg-gray-100 p-4">
              <p className="text-gray-500 text-sm text-center">
                ...
                <a
                  href="#"
                  className="text-amber-500 hover:text-amber-600 active:text-amber-700 transition duration-100"
                >
                  Register
                </a>
              </p>
